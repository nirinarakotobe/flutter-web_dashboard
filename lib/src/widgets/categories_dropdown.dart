...
class _CategoryDropdownState extends State<CategoryDropdown> {
  ...
  Stream<List<CategoryModel>>? _stream;
    ...
    return FutureBuilder<List<CategoryModel>>(
      ...
      builder: (context, futureSnapshot) {
        ...
        if (!futureSnapshot.hasData) {
          return DropdownButton<CategoryModel>(items: const [], onChanged: null);
        }
        ...
        return StreamBuilder<List<CategoryModel>>(
          ...
          builder: (context, snapshot) {
            var data = snapshot.hasData ? snapshot.data! : <CategoryModel>[];
  ...
  void _setSelected(CategoryModel? category) {
  ...
  DropdownMenuItem<CategoryModel> _buildDropdownItem(CategoryModel category) {
